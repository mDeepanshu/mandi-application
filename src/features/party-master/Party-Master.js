...
const PartyMaster = () => {
  ...
  const [partyColumns, setPartyColumns] = useState(["INDEX", "CONTACT", "ID NO", "PARTY NAME", "KISAN TYPE", "COMMISSION", "OWED AMOUNT", "MAX LOAN DAYS", "Last Vasuli Date", "Ledger Order", "Auto Ledger", "CHUNGI", "Days Exceded", "PARTY TYPE", "PARTY CODE", "EDIT"]);
  const [keyArray, setKeyArray] = useState(["index", "contact", "idNo", "name", "kisanType", "commission", "owedAmount", "maxLoanDays", "lastVasuliDate", "ledgerOrder", "autoLedger", "chungi", "daysExceded", "partyType", "partyCode", "edit"]);
